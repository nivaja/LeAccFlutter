            ...
            FormBuilder(
                ...
                child: Column(
                  children: [
                    ...
                    FormBuilderTextField(name: 'phone_number', decoration: FrappeInputDecoration(label: 'Phone Number', fieldIcons: const Icon(Icons.phone))),
                    FormBuilderTextField(name: 'email',validator: FormBuilderValidators.compose([FormBuilderValidators.email(), FormBuilderValidators.required()]), decoration: FrappeInputDecoration(label: 'Email', fieldIcons: const Icon(Icons.email))),
